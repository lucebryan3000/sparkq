...
Batch 1:
\`\`\`bash
codex exec --full-auto -C /home/luce/apps/sparkq "[Prompt 1]"
\`\`\`

Batch 2 (Parallel):
\`\`\`bash
codex exec --full-auto -C /home/luce/apps/sparkq "[Prompt 2]" &
codex exec --full-auto -C /home/luce/apps/sparkq "[Prompt 3]" &
wait
\`\`\`
...
```bash
codex exec --full-auto -C /home/luce/apps/sparkq "
