...
from {{SRC_DIR}}.constants import DEFAULT_TOOL_TIMEOUT_SECONDS, TASK_CLASS_TIMEOUTS
from {{SRC_DIR}}.tools import ToolRegistry, reload_registry
...
def temp_config(tmp_path):
    config_path = tmp_path / "{{PROJECT_NAME_SNAKE}}.yml"
    ...
    os.environ["{{PROJECT_NAME_SNAKE|upper}}_CONFIG"] = str(config_path)
    return config_path
