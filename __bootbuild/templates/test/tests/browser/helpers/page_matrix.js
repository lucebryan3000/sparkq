...
export const pages = [
  ...
  { name: '{{PROJECT_NAME}}', module: '{{PROJECT_NAME_PASCAL}}', tab: '{{PROJECT_NAME}}', selector: '#{{PROJECT_NAME}}-page' },
  // Queues page is aliased to the {{PROJECT_NAME_PASCAL}} tab
  { name: 'queues', module: 'Queues', tab: '{{PROJECT_NAME}}', selector: '#{{PROJECT_NAME}}-page' },
