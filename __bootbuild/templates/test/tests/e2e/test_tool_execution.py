...
from {{SRC_DIR}}.tools import reload_registry, ToolRegistry
...
class TestToolExecution:
    ...
    def test_timeout_configuration_per_task_class(self, tool_runner):
        ...
        # Verify config loaded correctly from {{PROJECT_NAME_SNAKE}}.yml
        import yaml
        from pathlib import Path

        config_path = Path("{{PROJECT_NAME_SNAKE}}.yml")
