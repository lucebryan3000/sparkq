...
import {{PROJECT_NAME_SNAKE}}.queue_runner as queue_runner
from {{SRC_DIR}} import api as api_module
...
def queue_runner_env(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("{{PROJECT_NAME_SNAKE}}.queue_runner.requests", client)
