...
echo ""
log_section "PostgreSQL Bootstrap Complete"
...
echo "     docker-compose -f docker-compose.postgres.yml exec postgres psql -U $DB_USER -d $DB_NAME -c '\\dt'"
echo ""
echo "  3. Run backups:"
echo "     bash database/postgres/backup.sh"
echo ""
...
echo "  • Change DB_PASSWORD in .env.postgres (current: $DB_PASSWORD)"
echo "  • Never commit .env.postgres to git"
